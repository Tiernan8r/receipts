...
#
# Sample postprocessing script for gnome-receipts for OCR in PDFs
#
...
# postprocessing step to PDFs generated by receipts.
#
# Usage:
# =====
# receipts-postprocessing mime-type keep-origin input-file args
#
...
# Example:
# =======
# receipts-postprocessing application/pdf true scan.pdf -l eng+deu
# receipts-postprocessing application/pdf true scan.pdf -rcd --jbig2-lossy -l deu
#
set -e +m
